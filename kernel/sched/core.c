...
>>>>>>> sched: Window-based load stat improvements 2
/*
 ...
 * Mark the task runnable and perform wakeup-preemption.
 */
>>>>>>> sched: window-based load stats for tasks 2
static void
 ...
 *  This covers the NO_HZ=n code, for extra head-aches, see the comment below.
 */
>>>>>>> msm: intelli_plug: merged scheduler patches for intelli plug 1
...
>>>>>>> sched: Make scheduler aware of cpu frequency state 1
